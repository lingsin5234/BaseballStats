...
o1_time = t.time()
gv.full_output = pd.read_csv('OUTPUT.csv')
print(gv.full_output.from_dict(gv.full_output, 'columns').drop('Unnamed: 0', axis=1))
print(type(gv.full_output.from_dict(gv.full_output, 'columns').drop('Unnamed: 0', axis=1).loc[0, 'game_id']))
exit()
