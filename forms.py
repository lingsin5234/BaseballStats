...
class GetYear(forms.Form):
    get_year = forms.ChoiceField(choices=YEARS, widget=forms.RadioSelect, required=True)
...
class ProcessTeam(forms.Form):
    process_year = forms.ChoiceField(choices=YEARS, widget=forms.RadioSelect, required=True)
    get_team = forms.ChoiceField(choices=TEAMS, widget=forms.RadioSelect, required=True)
